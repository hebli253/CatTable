...
import com.spring.board.impl.BoardDaoSpring;
...
public class BoardControllerSpring {	
	...
	public String getBoard(BoardDo bdo,
		...
		BoardDo board = bdaoSpring.getBoard(bdo);
	...
	public String searchBoardList(@RequestParam(value="sortCon") String sortCon,
		...
		//ArrayList<BoardDo> bList = bdao.searchBoardList(sort);
		ArrayList<BoardDo> bList = bdaoSpring.sortBoardList(sortCon);
		model.addAttribute("bList", bList);
